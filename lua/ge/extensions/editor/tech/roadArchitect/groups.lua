...
local prefabGroupFilepaths = {                                                                      -- A table of paths to the prefab group preset data files.
  { path = 'tech/PrefabGroups/x-junction.json', name = 'X-Junction 4W | 1L' },
  { path = 'tech/PrefabGroups/t-junction.json', name = 'T-Junction 3W | 1L' },
  { path = 'tech/PrefabGroups/y-junction.json', name = 'Y-Junction 3W | 1L' },
  { path = 'tech/PrefabGroups/riro_junction.json', name = 'RIRO Jct 4W' },
  { path = 'tech/PrefabGroups/roundabout_2l.json', name = 'Roundabout 4W | 2L' },
  { path = 'tech/PrefabGroups/roundabout_1l.json', name = 'Roundabout 4W | 1L' },
  { path = 'tech/PrefabGroups/intersection_unlinked.json', name = 'Int 4W [unlinked]' },
  { path = 'tech/PrefabGroups/riro_intersection.json', name = 'RIRO Int 4W' },
  { path = 'tech/PrefabGroups/diamond_4w.json', name = 'Diamond 4W' },
  { path = 'tech/PrefabGroups/roundabout_intersection.json', name = 'Roundabout Int 4W' },
  { path = 'tech/PrefabGroups/cloverleaf_int_4w.json', name = 'Cloverleaf 4W' },
  { path = 'tech/PrefabGroups/four-level-stack_4w.json', name = '4-Level Stack 4W' }
}
