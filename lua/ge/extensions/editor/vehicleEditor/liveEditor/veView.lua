...
local function _windowContent(id, sceneViewName, view)
  ...
  if focusObj then
    view.control.renderView:addFocusObject(focusObj)
  else
    view.control.renderView:exitFocusObjectsMode()
  end
  ...
  -- example code for raycasting in renderviews:
  --[[
  local res, startPt, endPt = view.control.renderView:getUnprojectedRayStartEnd(0, 0)
  dump{'getUnprojectedRay = ', res, startPt, endPt}
  res = rayCastStartPosEndPos(startPt, endPt)
  dump{'rayCastStartPosEndPos', res}
  ]]
