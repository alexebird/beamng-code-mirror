...
local function setupPathCamera()
  ...
  if democam and democam.className == 'SimPath' then
    ...
    if pathCameraData.hasDemo or pathCameraData.hasIntro then
      pathCameraData.sequence = 0

      pathCameraData.reset = function(this)
        this.sequence = 0
      end

      pathCameraData.getNextPath = function(this)
        if this.hasCampaignIntro then
          this.hasCampaignIntro = nil
          return "democam_campaign_intro"
        end

        if this.hasDemo and this.sequence > 0 then
      ...
      pathCameraData.finishedPath = function(this)
    ...
    core_camera.setByName(0, "path", false, pathCameraData)
    core_camera.resetCamera(0)
  end
end
