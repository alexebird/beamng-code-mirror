...
.controller('MapViewCtrl', ['$rootScope', '$scope', '$stateParams', 'gamepadNav', function ($rootScope, $scope, $stateParams, gamepadNav) {
  // $stateParams.data.points = [
    ...
    //     "state": "ready",
    //     "onClick": "campaign_exploration.onFocusPOI(\"cliffjump\")",
    //     "objectives": {
    //       "bla1": true,
    //       "bla2": false,
    //       "bla3": false
    ...
    //   "state": "ready",
    //   "onClick": "campaign_exploration.onFocusPOI(\"driver_training_1\")",
    //   "objectives": {
    //     "bla1": true,
    //     "bla2": false,
    //     "bla3": false
    ...
    //   "state": "failed",
    //   "onClick": "campaign_exploration.onFocusPOI(\"highway\")",
    //   "objectives": {
    //     "bla1": true,
    //     "bla2": false,
    //     "bla3": false
    ...
    //   "title": "campaigns.training.training.training_acceleration_braking.title",
    //   "state": "bronze",
    //   "onClick": "campaign_exploration.onFocusPOI(\"training\")",
    //   "objectives": {
    //     "bla1": true,
    //     "bla2": false,
    //     "bla3": false
  ...
  $scope.$on('$destroy', () => {
    ...
    $rootScope.$broadcast('ToggleMissionPopups', true)
  })
...
.directive('missionsMap', ['$compile', function ($compile) {
  return {
    template: `
      <div class="missions-map container" >
    ...
    link: function (scope, element, attrs) {
      ...
      var initialize = function () {
        bngApi.engineLua("Engine.Audio.playOnce('AudioGui', 'event:/UI/Generic/Select')")
  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      element.on('focus', () => {
        ...
        bngApi.engineLua("Engine.Audio.playOnce('AudioGui', 'event:>UI_V2>click_hover_01')")
      })
